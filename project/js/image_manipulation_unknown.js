...
function sendFile_unknown(file) {
    ...
    xhr.onreadystatechange = () => {                                            //faz o .js esperar que o POST termine e o servidor envie uma resposta antes de continuar
        ...
        if (xhr.readyState === XMLHttpRequest.DONE && xhr.status === 200) {
            ...
            show_manipulated_image_unknown(JSON.parse( xhr.response ));       //o JSON.parse é essencial para usar a resposta como dicionário, como é pretendido
            }
        };
...
function show_manipulated_image_unknown(response) {     //mostra a imagem  manipulada; resultado das 2 outros imagens
    ...
    if (response["result"] != "unknown_falhou") {
        ...
        alert("The chosen image could not be unknown.");
    }
...
export {manipulateImage_unknown, sendFile_unknown, show_manipulated_image_unknown};